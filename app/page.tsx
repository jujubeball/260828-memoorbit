...
export default function Home(): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <main
        className={`mx-auto mt-14 w-full max-w-full overflow-x-hidden px-4 xl:mt-0 xl:max-w-5xl ${activeSection === "timeline" ? "pb-8" : "pb-28"} ${activeSection === "orbit" ? "xl:h-dvh xl:overflow-hidden xl:pb-0" : ""}`}
      >
        {activeSection === "memos" && (
          <>
            <div
