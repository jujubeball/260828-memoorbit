...
const TAG_DISTRIBUTIONS: TagDistribution[] = [
  { tag: "개발", count: 70, subject: "프론트엔드 구조와 사용자 경험", imagePath: "/memo-images/development.png", imageMemoCount: 70 },
  { tag: "기록", count: 44, subject: "생각과 결정의 배경", imagePath: "/memo-images/journal.png", imageMemoCount: 44 },
  { tag: "일상", count: 30, subject: "평범한 하루에서 발견한 변화", imagePath: "/memo-images/daily-life.png", imageMemoCount: 30 },
  { tag: "육아", count: 20, subject: "아이와 함께 배우고 웃었던 순간", imagePath: "/memo-images/parenting.png", imageMemoCount: 20 },
  { tag: "여행", count: 12, subject: "낯선 장소에서 마주한 풍경", imagePath: "/memo-images/travel.png", imageMemoCount: 12 },
  { tag: "요리", count: 6, subject: "가족 식탁을 위한 조리 과정", imagePath: "/memo-images/cooking.png", imageMemoCount: 6 },
  { tag: "독서", count: 4, subject: "책에서 오래 남은 질문", imagePath: "/memo-images/reading.png", imageMemoCount: 4 },
  { tag: "음악", count: 6, subject: "오늘의 감정과 닮은 재생 목록", imagePath: "/memo-images/music.png", imageMemoCount: 6 },
  { tag: "운동", count: 4, subject: "몸의 리듬을 되찾은 짧은 움직임", imagePath: "/memo-images/exercise.png", imageMemoCount: 4 },
  { tag: "영화", count: 4, subject: "장면이 남긴 이야기와 여운", imagePath: "/memo-images/movie.png", imageMemoCount: 4 },
];
